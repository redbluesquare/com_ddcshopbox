...
<table class="table">
	<thead>
		<tr>
			...
			<th style="text-align:center"><?php echo JText::_('COM_DDC_CHECK_1'); ?></th>
			<th style="text-align:center"><?php echo JText::_('COM_DDC_CHECK_2'); ?></th>
		</tr>
	</thead>
	<?php 
...
<div class="col-xs-12">
	<p style="font-size:0.8em;text-align:right;"><i><?php echo "Delivered by Ushbub. Find us on Facebook and Twitter. <b>@USHBUB</b>"; ?></i></p>
</div>
</div>
<?php 
$page++;
