...
<div class="row" style="padding-bottom:10px;">
	<div class="col-md-12">
		...
		<input id="ddclocation" style="height:30px;min-width:500px;padding:3px;margin:2px 4px;" name="ddccity" placeholder="<?php echo JText::_('COM_DDC_ENTER_POSTCODE'); ?>" value="<?php echo $ddccity->town; ?>" />
...
<div class="row">
	...
	<h3><?php echo JText::_('COM_DDC_TELL_US_WHATS_HAPPENING');?></h3>
	<p><?php echo JText::_('COM_DDC_TELL_US_WHATS_HAPPENING_DESC')?></p>
	<form id="getInterestForm" class="form-horizontal">
		<?php foreach($this->form->getFieldset('get_event') as $field): ?>
	...
	<button class="btn btn-primary pull-right" id="submitIntBtn"><?php echo JText::_('COM_DDC_CTA_BTN3'); ?></button>
</div>
<button class="btn btn-primary" id="GetIntBtn"><?php echo JText::_('COM_DDC_HAVE_AN_EVENT_TO_SHARE'); ?></button>
	<div class="clearfix"></div>
</div>
<?php endif;?>
