	...
	<form action="<?php echo JRoute::_('index.php'); ?>"
      method="post" name="adminForm" id="adminForm">
                ...
                <ul class="nav nav-tabs">
  					...
  					<li><a data-toggle="tab" href="#product_prices"><?php echo JText::_('COM_DDC_PRODUCT_PRICES'); ?></a></li>
        ...
        <div  id="product_prices" class="tab-pane fade">
        	...
        	<div class="row-fluid">
        		<div class="span6">
        		<?php foreach($this->form->getFieldset('product_price_fields_left') as $field): ?>
					<?php if ($field->hidden):// If the field is hidden, just display the input.?>
						<?php echo $field->input;?>
					<?php else:?>
					<div class="control-group">
				...
				<div class="span6">
        		<?php foreach($this->form->getFieldset('product_price_fields_right') as $field): ?>
					<?php if ($field->hidden):// If the field is hidden, just display the input.?>
						<?php echo $field->input;?>
					<?php else:?>
					<div class="control-group">
